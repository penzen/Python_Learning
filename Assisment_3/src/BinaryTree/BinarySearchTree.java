...
public class BinarySearchTree<E> extends AbstractSet<E> implements SortedSet<E> {
    ...
    public boolean add(E o) {
        int beforeNumElements = numElements;
        hookAdd(this.rootNode);
        this.rootNode = recursiveAdd(rootNode, o);
        return beforeNumElements != numElements;
    }
    ...
    private BinaryTreeNode recursiveAdd(BinaryTreeNode node, E o) {
        if (node == null) {
            numElements++;
            return versionNode(o);
        }

        BinaryTreeNode newNode = hookAddTraversed(node);
        int comparison = compare(o, newNode.element);
        if (comparison < 0) {
            newNode.leftChild = recursiveAdd(newNode.leftChild, o);
        } else if (comparison > 0) {
            newNode.rightChild = recursiveAdd(newNode.rightChild, o);
        }
    ...
    public boolean remove(Object o) {
        int beforeNumElements = numElements;
        hookRemove(this.rootNode);
        E element = (E) o;
//        this.rootNode = recursiveRemove(rootNode, element);
        return beforeNumElements != numElements;
    }

//    private BinaryTreeNode recursiveRemove(BinaryTreeNode node, E o) {
//
//    }
...
//    // the unhook can also be done here.
...
//    }
    ...
    public class BinaryTreeNode {
        ...
        public BinaryTreeNode(E element, int version) {
            this.element = element;
            leftChild = null;
            rightChild = null;
        ...
        public BinaryTreeNode(E element, BinaryTreeNode leftChild, BinaryTreeNode rightChild, int version) {
            this.element = element;
